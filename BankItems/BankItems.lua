...
do
	...
	for i = 1, bankSlots do
		...
		elseif (mod(i, bankColumns) == 1) then
			ItemButtonAr[i]:SetPoint("TOPLEFT", ItemButtonAr[i-bankColumns], "BOTTOMLEFT", 0, -7)
		else
	...
	BagButtonAr[5]:SetPoint("TOPLEFT", ItemButtonAr[19], "BOTTOMLEFT", -195, -75) -- top row, bank bags
	...
	for _, i in ipairs(BAGNUMBERS) do
		...
		BagContainerAr[i].CloseButton:SetPoint("TOPRIGHT", 50, 50)
	end
